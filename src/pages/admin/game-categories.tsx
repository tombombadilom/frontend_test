...
import { GameCategoryForm } from './game-category-form';
...
interface AdminGameCategoriesPageProps {
  isNew?: boolean;
  isEdit?: boolean;
}

export default function AdminGameCategoriesPage({ isNew, isEdit }: AdminGameCategoriesPageProps) {
  const { id } = useParams();
  ...
  if (isNew) {
    return (
      <div className="container mx-auto py-6">
        <h1 className="text-3xl font-bold mb-6">Créer une nouvelle catégorie de jeux</h1>
        <GameCategoryForm />
      </div>
    );
  }
  ...
  if (isEdit && id) {
    return (
      <div className="container mx-auto py-6">
        <h1 className="text-3xl font-bold mb-6">Modifier la catégorie de jeux</h1>
        <GameCategoryForm editMode />
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold">Catégories de jeux</h1>
        <Link
          to="/admin/game-categories/new"
                  ...
                  <TableCell className="text-right">
                    <div className="flex items-center justify-end gap-2">
                      <Button variant="ghost" size="icon" asChild>
                        <Link to={`/admin/game-categories/edit/${category.id}`}>
